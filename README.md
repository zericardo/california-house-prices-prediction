...
To run the following commands you will need Docker and docker-compose installed on your machine.

Here we use the command "tail -F anything" on the docker-compose file just to keep the container running.
This allow us to attach to the running container with Vscode with the remote containers extension.
